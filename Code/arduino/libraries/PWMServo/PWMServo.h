...
#if defined(__AVR_ATmega168__) || defined(__AVR_ATmega328P__)|| defined(__AVR_ATmega328PB__) // Arduino
...
class PWMServo
{
  ...
  public:
    ...
    void writeMicroseconds(int usArg); //specify microseconds of pulse
