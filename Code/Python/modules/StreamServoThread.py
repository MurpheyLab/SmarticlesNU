...
class StreamServoThread(threading.Thread):
    ...
    def __init__(self,xbee,gait_f, frequency = 30, remote_device= None):
        ...
        self.gait=gait_f
        super().__init__(target=self.target_function, args = (self.gait,self.period_s,self.dev,self.xb), daemon = True)



    def target_function(self,gaitf,period_s,dev,xb):
        t=0
